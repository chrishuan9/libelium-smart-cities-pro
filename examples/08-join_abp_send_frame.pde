...
<title>LoRaWAN 08: Join ABP send frame | Libelium</title>
...
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'LoRaWAN 08: Join ABP send frame']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> LoRaWAN 08: Join ABP send frame</h3>

    <p>This example shows how to configure the module and send frames to a LoRaWAN gateway with ACK after join a network using ABP</p>
...
LoRaWAN example - Send Confirmed packets (ACK)<br />
<br />
------------------------------------<br />
...
3. Device address set OK<br />
4. Network Session Key set OK<br />
5. Application Session Key set OK<br />
...
------------------------------------<br />
<br />
Device EUI: 0102030405060708<br />
Device Address: 05060708<br />
<br />
Creating an ASCII frame<br />
===============================<br />
Current ASCII Frame:<br />
Length: 61<br />
Frame Type:  134<br />
frame (HEX): 3C3D3E86022334443343373036334439333734324634236E6F64655F30312330235354523A746869735F69735F615F737472696E67234241543A393823<br />
frame (STR): <=>�#4D3C7063D93742F4#node_01#0#STR:this_is_a_string#BAT:98#<br />
===============================<br />
1. Switch ON OK<br />
2. Join network OK<br />
3. Send Confirmed packet OK<br />
4. Switch OFF OK<br />
<br />
Creating an ASCII frame<br />
===============================<br />
...
Length: 61<br />
Frame Type:  134<br />
frame (HEX): 3C3D3E86022334443343373036334439333734324634236E6F64655F30312331235354523A746869735F69735F615F737472696E67234241543A393823<br />
frame (STR): <=>�#4D3C7063D93742F4#node_01#1#STR:this_is_a_string#BAT:98#<br />
===============================<br />
1. Switch ON OK<br />
2. Join network OK<br />
3. Send Confirmed packet OK<br />
4. Switch OFF OK<br />
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=LoRaWAN 08: Join ABP send frame&p[summary]=This+example+shows+how+to+configure+the+module+and+send+frames+to+a+LoRaWAN+gateway+with+ACK+after+join+a+network+using+ABP&p[url]=http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=LoRaWAN+08%3A+Join+ABP+send+frame&url=http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-08-join-abp-send-frame/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
