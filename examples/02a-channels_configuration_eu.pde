...
<title>LoRaWAN 02a: Channels EU or IN or ASIA-PAC / LATAM | Libelium</title>
...
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'LoRaWAN 02a: Channels EU or IN or ASIA-PAC / LATAM']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> LoRaWAN 02a: Channels EU or IN or ASIA-PAC / LATAM</h3>

    <p>This example shows how to configure the channels settings. There are 16 channels. The first three of them are always preconfigured and cannot be changed: 868.1 MHz, 868.3 MHz and 868.5 MHz. Besides other parameters can be changed in all channels: Duty Cycle, Data rate range and channel status</p>
    <div class="box materials"><h4>Required Materials</h4><p>1 x Waspmote<br />
1 x Battery<br />
1 x LoRaWAN EU or LoRaWAN IN or LoRaWAN ASIA-PAC / LATAM module<br />
1 x 868 MHz Antenna (for EU and IN modules) or 900 MHz Antenna (for ASIA-PAC / LATAM module)</p></div>
    <div class="box note"><h4>Notes</h4><p>- This example can be executed in Waspmote v12 and Waspmote v15</p></div>
...
LoRaWAN example - Channels configuration<br />
1. Switch ON OK<br />
2. Frequency set OK. Frequency:865000000<br />
3. Adaptive Data Rate disabled OK. Duty Cycle:999<br />
4. Data Rate range set OK. Data Rate min:0. Data Rate max:2<br />
5. Channel status set OK: 1<br />
4. Save configuration OK<br />
<br />
----------------------------<br />
Channel: 0<br />
  Freq: 868100000<br />
...
----------------------------<br />
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=LoRaWAN 02a: Channels EU or IN or ASIA-PAC / LATAM&p[summary]=This+example+shows+how+to+configure+the+channels+settings.+There+are+16+channels.+The+first+three+of+them+are+always+preconfigured+and+cannot+be+changed%3A+868.1+MHz%2C+868.3+MHz+and+868.5+MHz.+Besides+other+parameters+can+be+changed+in+all+channels%3A+Duty+Cycle%2C+Data+rate+range+and+channel+status&p[url]=http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=LoRaWAN+02a%3A+Channels+EU+or+IN+or+ASIA-PAC+%2F+LATAM&url=http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-02a-channels-configuration-eu/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
