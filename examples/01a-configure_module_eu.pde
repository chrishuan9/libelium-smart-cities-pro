...
<title>LoRaWAN 01a: Configure module EU IN ASIA-PAC / LATAM | Libelium</title>
...
<link rel="canonical" href="http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/" />
...
<script type="text/javascript">$('ul.section_list li').each(function(){$(this).width(($(this).parent('ul').width()/$('ul.section_list li').length) - 2)});$('ul.section_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.section_list li.last').css('left', $('ul.section_list li.last').width()-54);$('ul.section_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>')});$('ul.subsection_list').each(function() {var anchos = Array();var ancho_total = 0;var ancho_final = 0;var total = $(this).width() - 5;var numero = 0;var parent_id = $(this).attr('id');$('#'+parent_id+' li').each(function() {anchos[numero] = $(this).width();ancho_total += $(this).width();numero++});for(var i =0; i <numero; i++) {ancho_final+= parseInt(((anchos[i]*total)/ancho_total));$('#'+parent_id+' li#position_'+i).css('width', (parseInt((anchos[i]*total)/ancho_total)))}$('#'+parent_id+' li#position_0').css('width', $('#'+parent_id+' li#position_0').width()+total-ancho_final)});$('ul.subsection_list li.first').prepend('<div class="section_list_left"></div>');$('<div class="section_list_right"></div>').appendTo('ul.subsection_list li.last');$('ul.subsection_list li.last div.section_list_right').each(function() {$(this).css('left', $(this).parent('li').width()-(32-$(this).parent('li').attr('id').match(/[\d]+$/)*8)-54)});$('ul.subsection_list li').each(function() {if (!$(this).hasClass('first')) $(this).prepend('<div class="section_list_inter_left"></div>');if (!$(this).hasClass('last')) $(this).append('<div class="section_list_inter_right"></div>');$(this).css('left','-'+$(this).attr('id').match(/[\d]+$/)*8+'px')});$('ul.subsection_list').hide();if ($('ul.section_list li.active').length == 0) {} else {$('ul.subsection_list.static').show()}$('ul.section_list li').hover(function(e) {e.preventDefault();$('ul.section_list li').removeClass('hover');$('ul.subsection_list').hide();$(this).addClass('hover');$('ul#sub'+$(this).attr('id')).addClass('hover').show()});$('ul.subsection_list').hover(function() {e.preventDefault();$('#'+$(this).attr('id').substr(3)).addClass('hover'); $('ul.subsection_list').addClass('hover')}, function() { $(this).removeClass('hover') });</script>        <article>
    ...
    <div class="buttonshortslimdownload right" style="margin-right: 0">
        <a href="http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/?action=download" target="_blank"  onClick="_gaq.push(['_trackEvent', 'Example', 'DOWNLOAD', 'LoRaWAN 01a: Configure module EU IN ASIA-PAC / LATAM']);">
            <div></div> Download Code</a>
    </div>
    <h3 class="title"><span>&raquo;</span> LoRaWAN 01a: Configure module EU IN ASIA-PAC / LATAM</h3>

    <p>This example shows how to configure the module and all general settings related to back-end registration process.</p>
...
LoRaWAN example - Module configuration<br />
1. Switch ON OK<br />
2. Reset to factory default values OK<br />
3.1. Set Device EUI OK<br />
3.2. Get Device EUI OK. Device EUI: 0102030405060708<br />
4.1. Set Device address OK<br />
4.2. Get Device address OK. Device address: 05060708<br />
5. Set Network Session Key OK<br />
6. Set Application Session Key OK<br />
7.1. Set Retransmissions for uplink confirmed packet OK<br />
7.2. Get Retransmissions for uplink confirmed packet OK. TX retries: 7<br />
8. Application key set OK<br />
9. Frequency channel set OK<br />
9. Frequency channel set OK<br />
9. Frequency channel set OK<br />
9. Frequency channel set OK<br />
9. Frequency channel set OK<br />
10. Duty cycle channel set OK<br />
10. Duty cycle channel set OK<br />
10. Duty cycle channel set OK<br />
10. Duty cycle channel set OK<br />
10. Duty cycle channel set OK<br />
...
10. Duty cycle channel set OK<br />
10. Duty cycle channel set OK<br />
11. Data rate range channel set OK<br />
11. Data rate range channel set OK<br />
11. Data rate range channel set OK<br />
11. Data rate range channel set OK<br />
11. Data rate range channel set OK<br />
...
12. Channel status set OK<br />
	...
	<div id="social">
		...
		<div id="facebook" class="social popup">
			<a style="width:15px; height:25px; display:block;" title="Send to Facebook" href="http://www.facebook.com/sharer.php?s=100&p[title]=LoRaWAN 01a: Configure module EU IN ASIA-PAC / LATAM&p[summary]=This+example+shows+how+to+configure+the+module+and+all+general+settings+related+to+back-end+registration+process.&p[url]=http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/&p[images][0]=">
			</a>
		</div>
		<div id="twitter" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Twitter" href="http://twitter.com/share?text=LoRaWAN+01a%3A+Configure+module+EU+IN+ASIA-PAC+%2F+LATAM&url=http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/&via=libelium">
			</a>
		</div>
		<div id="linkedin" class="social popup">
			<a style="width:19px; height:25px; display:block;" title="Send to Linkedin" href="http://www.linkedin.com/cws/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/">
			</a>
		</div>
		<div id="googleplus" class="social popup">
			<a style="width:20px; height:25px; display:block;" title="Send to Google +" href="https://plus.google.com/share?url=http://www.libelium.com/development/waspmote/examples/lorawan-01a-configure-module-eu/"></a>
		</div>
	</div>
	<!-- /Motor Social -->
	    </div>
